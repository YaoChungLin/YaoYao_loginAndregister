...
<div class="w">
    <div id="logo">
    	<%-- <a href="http://www.yaoyao.com/" clstag="passport|keycount|login|01">
    		<img src="${staticUrl}/images/taotao-logo.gif" alt="皆有" width="170" height="60"/>
    	</a> --%>
    	<h1>欢迎登录！</h1>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 500px; height: 350px; position: absolute; left: px; top: px;">
            <img src="${staticUrl}/images/ppt.jpg" alt="" style="width: 500px; height: 350px;" />
			</div> 
            <div class="form ">
        ...
        <div class="free-regist">
            <span><a href="http://sso.yaoyao.com/user/register.html" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<!-- <div class="w1">
